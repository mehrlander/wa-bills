...
Mapping from XML Schema types to common programming language types.

| XSD Type | Description | JavaScript | Python | C# | Java |
|----------|-------------|------------|--------|----|----|
| `s:string` | Text | `string` | `str` | `string` | `String` |
| `s:int` | 32-bit integer | `number` | `int` | `int` | `int` |
| `s:boolean` | True/False | `boolean` | `bool` | `bool` | `boolean` |
| `s:dateTime` | ISO 8601 datetime | `Date` | `datetime` | `DateTime` | `LocalDateTime` |
