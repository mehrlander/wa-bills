...
const parser = new XMLParser({ 
    ...
    isArray: (name) => ['RcwCiteAffected','Sponsor','LegislationInfo','CommitteeAction','CommitteeReferral','LegislativeStatus','CommitteeRecommendation'].includes(name) 
});
...
/** CONVENIENCE FETCHERS - Legislation & Sponsors **/
...
/** CONVENIENCE FETCHERS - Committee Actions, Referrals, History **/
